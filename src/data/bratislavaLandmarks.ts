...
export const LANDMARKS: Landmark[] = [
  ...
  },
  {
    ...
    nameEn: 'Eurovea',
    category: 'namestie',
    lat: 48.1402, lng: 17.1217,
    description: 'Eurovea je moderná nákupná, administratívna a oddychová zóna pri Dunaji. Nachádzajú sa tu obchody, reštaurácie, promenáda, kino a verejné priestory vhodné na prechádzku popri rieke.',
  ...
  },
  {
    ...
    nameEn: 'Medical Garden',
    category: 'park',
    lat: 48.1491, lng: 17.1160,
    description: 'Medická záhrada je historický mestský park v centre Bratislavy. Je obľúbená na krátky oddych, prechádzky, detské aktivity a kultúrne podujatia.',
    address: 'Špitálska, 811 08 Bratislava',
    built: '18. storočie',
    icon: '🌳', color: '#16a34a',
  },
  {
    id: 'zoo-bratislava',
    name: 'Zoologická záhrada Bratislava',
    nameEn: 'Bratislava Zoo',
    category: 'park',
    lat: 48.1549, lng: 17.0740,
    description: 'Zoologická záhrada Bratislava sa nachádza v Mlynskej doline. Patrí medzi obľúbené rodinné miesta a ponúka expozície zvierat, výbehy, detské zóny a náučné trasy.',
    address: 'Mlynská dolina 1A, 842 27 Bratislava',
    icon: '🦁', color: '#16a34a',
  },
  {
    id: 'kamzik',
    name: 'Kamzík',
    nameEn: 'Kamzik TV Tower',
    category: 'most',
    lat: 48.1822, lng: 17.0990,
    description: 'Kamzík je výrazný bod Malých Karpát nad Bratislavou s televíznou vežou, lesoparkom a turistickými trasami. Lokalita ponúka výhľady na mesto a možnosti prechádzok v prírode.',
    address: 'Cesta na Kamzík, Bratislava',
    icon: '📡', color: '#ea580c',
  },
  {
    id: 'botanicka-zahrada-uk',
    name: 'Botanická záhrada UK',
    nameEn: 'Comenius University Botanical Garden',
    category: 'park',
    lat: 48.1476, lng: 17.0717,
    description: 'Botanická záhrada Univerzity Komenského je zelený areál s vonkajšími expozíciami, skleníkmi a zbierkami rastlín. Je vhodná na tichú prechádzku aj vzdelávanie.',
    address: 'Botanická 3, 841 04 Bratislava',
    icon: '🌿', color: '#16a34a',
  },
  {
    id: 'aupark',
    name: 'Aupark',
    nameEn: 'Aupark Shopping Center',
    category: 'namestie',
    lat: 48.1327, lng: 17.1077,
    description: 'Aupark je nákupné centrum v Petržalke pri Sade Janka Kráľa. Ponúka obchody, služby, reštaurácie a dobré spojenie s centrom mesta cez Most SNP.',
  ...
  },
  {
    ...
    nameEn: 'Ondrej Nepela Arena',
    category: 'divadlo',
    lat: 48.1591, lng: 17.1352,
    description: 'Zimný štadión Ondreja Nepelu je hlavná bratislavská aréna pre hokej, koncerty a veľké kultúrne podujatia. Nachádza sa v mestskej časti Nové Mesto.',
    address: 'Odbojarov 9, 831 04 Bratislava',
    icon: '🏒', color: '#be185d',
  },
  {
    id: 'letisko-bratislava',
    name: 'Letisko M. R. Štefánika',
    nameEn: 'Bratislava Airport',
    category: 'doprava',
    lat: 48.1702, lng: 17.2127,
    description: 'Letisko M. R. Štefánika je hlavné medzinárodné letisko Bratislavy. Slúži pre pravidelné aj sezónne lety a je napojené na mestskú hromadnú dopravu.',
    address: 'Ivanská cesta, 820 01 Bratislava',
    icon: '✈️', color: '#b45309',
  },
];
