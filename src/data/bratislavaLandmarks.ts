...
// 800 px Wikimedia thumbs — freely licensed
const W = (path: string) =>
...
export const LANDMARKS: Landmark[] = [
  ...
  /* ── Historické pamiatky ─────────────────────────────────── */
  {
    ...
    photo: W('b/b4/Bratislava_-_Burg_%28b%29.JPG/800px-Bratislava_-_Burg_%28b%29.JPG'),
    description:
  ...
  },
  {
    ...
    photo: W('1/1e/Catedral_de_San_Mart%C3%ADn%2C_Bratislava%2C_Eslovaquia%2C_2020-02-01%2C_DD_48.jpg/800px-Catedral_de_San_Mart%C3%ADn%2C_Bratislava%2C_Eslovaquia%2C_2020-02-01%2C_DD_48.jpg'),
    description:
  ...
  },
  {
    ...
    photo: W('e/ef/Bratislava_blue_church.jpg/800px-Bratislava_blue_church.jpg'),
    description:
  ...
  },
  {
    ...
    photo: W('2/29/Bratislava14Slovakia65.JPG/800px-Bratislava14Slovakia65.JPG'),
    description:
  ...
  },
  {
    ...
    photo: W('d/d2/Palacio_primacial%2C_Bratislava%2C_Eslovaquia%2C_2020-02-01%2C_DD_30.jpg/800px-Palacio_primacial%2C_Bratislava%2C_Eslovaquia%2C_2020-02-01%2C_DD_30.jpg'),
    description:
  ...
  },
  {
    ...
    photo: W('4/45/Michael%27s_Gate_Bratislava_Slovakia.jpg/800px-Michael%27s_Gate_Bratislava_Slovakia.jpg'),
    description:
  ...
  },
  {
    ...
    photo: W('3/3d/Most_SNP%2C_Bratislava_%28by_Pudelek%29.JPG/800px-Most_SNP%2C_Bratislava_%28by_Pudelek%29.JPG'),
    description:
  ...
  },
  {
    ...
    photo: W('2/20/Bratislava10Slovakia117.JPG/800px-Bratislava10Slovakia117.JPG'),
    description:
      'Slovenské národné divadlo je najstaršie profesionálne divadlo na Slovensku. Pôvodná historická budova z roku 1886 sa nachádza na Hviezdoslavovom námestí. Nová budova SND, otvorená v roku 2007, je moderná stavba pri nábreží Dunaja. Divadlo ponúka operu, balet a drámu.',
  ...
  },
  {
    ...
    photo: W('d/d1/Hviezdoslavovo_n%C3%A1mestie_%2810267450433%29.jpg/800px-Hviezdoslavovo_n%C3%A1mestie_%2810267450433%29.jpg'),
    description:
  ...
  },
  {
    ...
    description:
      'Slovenské národné múzeum je najstaršia a najväčšia múzejná inštitúcia na Slovensku. Budova pri nábreží Dunaja bola postavená v roku 1928. Múzeum spravuje zbierky z oblasti prírodných vied, histórie, archeológie a etnografie. Nachádza sa tu aj slávna výstava dinosaurov a prehistorických nálezov zo Slovenska.',
  ...
  },
  {
    ...
    photo: W('c/cd/Palacio_Grassalkovich%2C_Bratislava%2C_Eslovaquia%2C_2020-02-01%2C_DD_21.jpg/800px-Palacio_Grassalkovich%2C_Bratislava%2C_Eslovaquia%2C_2020-02-01%2C_DD_21.jpg'),
    description:
      'Prezidentský palác (Grassalkovičov palác) je barokový palác postavený okolo roku 1760 pre grófa Antala Grassalkoviča. Palác slúžil ako sídlo Márie Terézie počas jej pobytov v Bratislave. Dnes je officiálnym sídlom prezidenta Slovenskej republiky. Pred palácom je rozsiahla záhrada prístupná verejnosti.',
  ...
  },
  {
    ...
    photo: W('7/74/Sad_Janka_Krala%2C_Bratislava%2C_Slovakia.JPG/800px-Sad_Janka_Krala%2C_Bratislava%2C_Slovakia.JPG'),
    description:
  ...
  },
  {
    ...
    photo: W('1/16/Devin02.jpg/800px-Devin02.jpg'),
    description:
      'Zrúcanina hradu Devín sa nachádza na skalnom výbežku nad sútokom Dunaja a Moravy, na štátnej hranici s Rakúskom. Hrad bol dôležitou pevnosťou Veľkomoravskej ríše v 9. storočí. Napoleon dal hrad v roku 1809 vyhodiť do vzduchu. Dnes je národnou kultúrnou pamiatkou a obľúbenou turistickou destináciou.',
  ...
  },
  {
    ...
    description:
      'Slavín je vojenský cintorín a pamätník, kde sú pochovaní sovietski vojaci padlí počas oslobodenia Bratislavy v apríli 1945. Dominantou je 39-metrový obelisk korunovaný sochou vojaka. Z vyhliadkovej terasy cintorína je jeden z najkrajších výhľadov na Bratislavu a okolie.',
  ...
  /* ── Dôležité mestské miesta ─────────────────────────────── */
  {
    ...
    description:
      'Magistrát hlavného mesta SR Bratislavy je sídlo mestskej samosprávy. Poskytuje všetky služby súvisiace so správou mesta – povolenia, registrácie, informácie pre občanov aj turistov. Úradné hodiny: Pondelok–Piatok 8:00–17:00.',
    address: 'Primaciálne nám. 1, 814 99 Bratislava',
    icon: '🏛️', color: '#6d28d9',
  },
  {
    ...
    description:
      'Krajské riaditeľstvo Policajného zboru v Bratislave. V prípade núdze volajte linku 158 (polícia) alebo 112 (európska tiesňová linka). Polícia zabezpečuje verejný poriadok a bezpečnosť občanov.',
  ...
  },
  {
    ...
    description:
      'Mestská polícia Bratislava zabezpečuje verejný poriadok na území mesta. Linka mestskej polície: 159. Hliadky sú nepretržite k dispozícii v celom meste.',
  ...
  },
  {
    ...
    photo: W('8/83/Bratislava_hlavn%C3%A1_stanica_September_2019.jpg/800px-Bratislava_hlavn%C3%A1_stanica_September_2019.jpg'),
    description:
      'Bratislava hlavná stanica je najväčšia a najdôležitejšia železničná stanica v Bratislave. Odchádzajú odtiaľto vlaky do celej SR, ako aj medzinárodné spoje do Viedne, Prahy, Budapešti a ďalších miest. V priestoroch stanice sa nachádzajú obchody, reštaurácie a informačné centrum.',
  ...
  },
  {
    ...
    description:
      'Moderná autobusová stanica Nivy (Nivy Station) je centrálnym terminálovým uzlom medzimestskej a medzinárodnej autobusovej dopravy. Nachádza sa v obchodnom centre Nivy. Odchádzajú odtiaľto autobusy do celej SR aj do zahraničia.',
  ...
  },
  {
    ...
    description:
      'Univerzitná nemocnica Bratislava – Nemocnica akad. L. Dérera na Kramároch je jednou z najväčších nemocníc na Slovensku. Poskytuje komplexnú zdravotnícku starostlivosť vrátane pohotovosti. Pohotovosť: nonstop. Telefón: +421 2 5954 1111.',
  ...
  },
  {
    ...
    description:
      'Univerzitná nemocnica svätého Michala (Ružová dolina) je nemocnica v centre Bratislavy. Poskytuje zdravotnícke služby vo viacerých odbornostiach. Pohotovosť pre dospelých je prístupná. Telefón: +421 2 4823 0111.',
  ...
  },
  {
    ...
    description:
      'Lekáreň na Obchodnej ulici v centre Bratislavy. Ponúka voľnopredajné lieky, výdaj na predpis a zdravotnícke poradenstvo. Otváracie hodiny: Po–Pia 8:00–20:00, So 9:00–14:00. Ďalšie lekárne nájdete v každom väčšom nákupnom centre.',
  ...
  },
  {
    ...
    description:
      'Hlavná pobočka Slovenskej pošty v centre Bratislavy. Poskytuje všetky poštové služby – odosielanie listov a balíkov, poštové poukazy, predaj cenín. Otváracie hodiny: Pondelok–Piatok 8:00–19:00, Sobota 9:00–13:00.',
