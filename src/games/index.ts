...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    description: 'Otočte kartičky a nájdite páry slovenských pamiatok!',
    color: '#16a34a',
  ...
  },
  {
    ...
    description: 'Poskladajte fotografie slovenských miest, hradov a kostolov!',
    color: '#7c3aed',
  ...
  },
  {
    ...
    description: 'Kvíz o slovenských mestách, histórii a zaujímavostiach!',
    color: '#ea580c',
